<x-app-layout>
    ...
    <form method="POST" action="{{ route('classes.store') }}" class="max-w-xl space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" placeholder="cth. X RPL 1" required autofocus />
